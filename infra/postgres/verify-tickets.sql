...
SELECT pg_temp.assert_true((SELECT count(*)=3 AND bool_and(tgenabled='A') FROM pg_trigger WHERE tgrelid='app.tickets'::regclass AND NOT tgisinternal),'triggers de ticket activos');
