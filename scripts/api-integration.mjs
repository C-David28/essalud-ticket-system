...
try {
  ...
  for(const file of ['verify-multi-tenant.sql','verify-audit.sql','verify-tickets.sql','verify-ticket-states.sql','verify-ticket-assignment.sql','verify-organization.sql','verify-access.sql','verify-geography.sql']) {
